  ...
  try {
    ...
    const customerHtml = `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px">
        ...
        <p>Questions? Email us at <a href="mailto:hello@wonderworldwestgate.store">hello@wonderworldwestgate.store</a></p>
        <p>See you soon! 🎠</p>
    ...
    const customerRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'Wonder World Westgate <bookings@wonderworldwestgate.store>',
        to: [email],
    ...
    if (admins && admins.length > 0) {
      ...
      const adminHtml = `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px">
          ...
          <p><a href="https://wonderworldwestgate.store/admin" style="background:#4F46E5;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;display:inline-block">View in Admin Dashboard →</a></p>
        </div>`;

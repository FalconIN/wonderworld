...
--   psql -U wonderworld -d wonderworld -f schema-postgres.sql
-- ============================================================
...
CREATE TABLE IF NOT EXISTS public.bookings (
  ...
  -- Admin "extra kids" whole-venue upgrade (see server/routes/admin.js
  -- POST /bookings/:id/upgrade-to-venue and migration-venue-upgrade.sql).
  -- NULL = never upgraded.
...
-- Extra-kids whole-venue-upgrade payment links. See
-- server/routes/admin.js, server/routes/payments.js, and
-- migration-venue-upgrade.sql.
...
-- Dedicated system actor for the venue-upgrade auto-revert cron job (see
-- server/services/venueUpgradeExpiry.js) — booking_edits.changed_by is
-- NOT NULL and there's no admin to attribute an automatic revert to.
